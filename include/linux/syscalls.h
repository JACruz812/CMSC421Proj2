...
long compat_ksys_semtimedop(int semid, struct sembuf __user *tsems,
			    unsigned int nsops,
			    const struct old_timespec32 __user *timeout);
//Declarations for new sys calls
asmlinkage long create_mbx_421(const char __user *name, unsigned long size);
asmlinkage long resize_mbx_421(const char __user *name, unsigned long size);
asmlinkage long delete_mbx_421(const char __user *name);
asmlinkage long write_mbx_421(const char __user *name,
	       		      const unsigned char __user *data,
			      long offset, long n);
asmlinkage long read_mbx_421(const char __user *name, unsigned char __user *data,
	       		     long offset, long n);
asmlinkage long size_mbx_421(const char __user *name);
asmlinkage long list_mbx_421(char __user  **list, unsigned long max_entries);
asmlinkage long count_mbx_421(void);
